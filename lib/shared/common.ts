    ...
    try {
      ...
      if (typeof request.key === 'number') {
        ...
        if (!requestCallbacks) {
          ...
          // See https://github.com/aperturerobotics/esbuild/issues/3318 for details.
          return
        }
...
function sanitizeLocation(location: types.PartialMessage['location'], where: string, terminalWidth: number | undefined): types.Message['location'] {
  ...
  // to avoid the performance hit. See: https://github.com/aperturerobotics/esbuild/issues/3467
  if (lineText) {
